...
app.config(function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, ASSETS){
	...
	$stateProvider.
	 ...
	 state('app.profil', {
			url: '/profil/:id',
			templateUrl: appHelper.templatePath('ProfilCompany'),
		    controller : "profileCtrl"
	}).
	state('app.actualities', {
			url: '/actualities',
			templateUrl: appHelper.templatePath('actualities'),
		    
	}).
	
	 state('app.recherche', {
			url: '/recherche',
			templateUrl: appHelper.templatePath('recherche'),
		}).
	
	
	state('app.Categories', {
		url: '/Categories-list',
		templateUrl: appHelper.templatePath('Categories/list'),
		resolve: {
	...
	state('app.Materials', {
		url: '/Materials-list',
		templateUrl: appHelper.templatePath('Materials/list'),
	...
	state('app.Materials-Create', {
		...
		templateUrl: appHelper.templatePath('Materials/Create'),
		resolve: {
	...
	state('app.Materials-Detail', {
		...
		templateUrl: appHelper.templatePath('Materials/Detail'),


	}).

	state('app.Materials-Edit', {
		url: '/Materials-Edit',
		templateUrl: appHelper.templatePath('Materials/Edit'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
	...
	state('app.Services', {
		url: '/Services-list',
		templateUrl: appHelper.templatePath('Services/list'),

	}).
	
	state('app.Services-Create', {
		url: '/Services-Create',
		templateUrl: appHelper.templatePath('Services/Create'),
	...
	state('app.Services-Detail', {
		url: '/Services-Detail',
		templateUrl: appHelper.templatePath('Services/Detail'),
	...
	state('app.Events', {
		url: '/Events-list',
		templateUrl: appHelper.templatePath('Events/list'),

	}).
	
	state('app.Events-Create', {
		url: '/Events-Create',
		templateUrl: appHelper.templatePath('Events/Create'),
	...
	state('app.Events-Detail', {
		url: '/Events-Detail',
		templateUrl: appHelper.templatePath('Events/Detail'),
	...
	state('app.StoreHouses', {
		url: '/StoreHouses-list',
		templateUrl: appHelper.templatePath('StoreHouses/list'),
	...
	state('app.StoreHouses-Create', {
		url: '/StoreHouses-Create',
		templateUrl: appHelper.templatePath('StoreHouses/Create'),


	}).

	state('app.StoreHouses-Detail', {
		url: '/StoreHouses-Detail',
		templateUrl: appHelper.templatePath('StoreHouses/Detail'),


	}).

	state('app.StoreHouses-Edit', {
		url: '/StoreHouses-Edit',
		templateUrl: appHelper.templatePath('StoreHouses/Edit'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
    ...
    state('app.recruitment', {
		...
		templateUrl: appHelper.templatePath('recruitment/list'),
	...
	state('app.recruitment-Detail', {
		url: '/recruitment-Detail',
		templateUrl: appHelper.templatePath('recruitment/Detail'),
    ...
    state('app.Appointments', {
		...
		templateUrl: appHelper.templatePath('Appointments/list'),
    ...
    state('app.Appointments-Create', {
		...
		templateUrl: appHelper.templatePath('Appointments/Create'),
	...
	//Entreprises
     ...
     state('app.Entreprises', {
		...
		templateUrl: appHelper.templatePath('Entreprises/list'),
		resolve: {
			deps: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.tables.datatables,
    ...
    state('app.Entreprises-Edit', {
		url: '/Entreprises-Edit',
		templateUrl: appHelper.templatePath('Entreprises/Edit'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
    ...
    state('app.Entreprises-Detail', {
		url: '/Entreprises-Detail',
		templateUrl: appHelper.templatePath('Entreprises/Detail'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
...
//Idea 
    state('app.Idea', {
		url: '/Idea-list',
		templateUrl: appHelper.templatePath('Idea/list'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
    ...
    state('app.Idea-Create', {
		url: '/Idea-Create',
		templateUrl: appHelper.templatePath('Idea/Create'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
    ...
    state('app.Idea-Detail', {
		url: '/Idea-Detail',
		templateUrl: appHelper.templatePath('Idea/Detail'),
		resolve: {
			dropzone: function($ocLazyLoad){
				return $ocLazyLoad.load([
					ASSETS.forms.dropzone,
	...
	// Mailbox
		...
		// Extra
			...
			state('app.extra-Detail', {
			url: '/extra-Detail',
			templateUrl: appHelper.templatePath('extra/Detail'),
