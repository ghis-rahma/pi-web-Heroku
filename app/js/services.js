...
angular.module('xenon.services', [])
    ...
    .factory('AngularIssues',function($resource){
         return $resource('http://localhost:18080/ERP.PI-web/rest/Candidacy/all',{})
         })
    ...
    .service('$menuItems', function()
	{
		...
		this.prepareSidebarMenu = function()
		{
			...
			var Statistics     = this.addItem('Statistics',     '/app/Statistics', 		'linecons-cog');
			var services =    this.addItem("My Services"  , '/app/Services', 		'linecons-cog' ); 
			var events =  this.addItem("My Events"  , '/app/Events', 		'linecons-cog' ); 
			
			var Categories    = this.addItem('Products', 		'/app/Categories', 		'linecons-beaker');
			var Materials     = this.addItem('Materials', 		'/app/Materials', 		'linecons-cog');
			var StoreHouses   = this.addItem('StoreHouses',     '/app/StoreHouses', 	'linecons-cog');
			var Commands      = this.addItem('Commands', 		'/app/Commands', 	    'linecons-cog');
			var Suppliers     = this.addItem('Suppliers', 		'/app/Suppliers', 		'linecons-cog');
            var Recruitment   = this.addItem('recruitment', 		'/app/recruitment', 'linecons-cog');
            var Appointments  = this.addItem('Appointments', 		'/app/Appointments', 'linecons-cog');
			...
			// Subitems of Categories
			
			events.addItem ("Creat new Event" , '-/Create');
             events.addItem ("List of Events" , '-/list');
			 services.addItem ("Creat new Service" , '-/Create');
			 services.addItem ("List of Service" , '-/list');
			
			Categories.addItem('List Of Products',   '-/list' )
			...
			StoreHouses.addItem ('List of StoreHouses', '-/list')
				...
				dashboard.addItem('Hello', 	'-/variant-1'); // "-/" will append parents link
				...
				dashboard.addItem('Update Hightlights', '/app/update-highlights').setLabel('v1.3', 'pink');
                 //SubItems of Recruitment
                Recruitment.addItem('List Of Candidacies','-/list');
                //SuItems of Appointments
                Appointments.addItem('List Of Appointments','-/list');
		...
		{
			var Categories    = this.addItem('Categories', 		'/app/Categories', 		'linecons-cog');
			var dashboard    = this.addItem('Dashboard', 		'/app/dashboard', 			'linecons-cog');
			...
			Categories.addItem("List Of Categories",    '-/list')
